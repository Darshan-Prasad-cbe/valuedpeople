...
const jobPostings = [
  {
    ...
    description: 'Seeking skilled CNC operators with expertise in programming and precision machining.',
  },
  {
    id: 2,
    ...
    description: 'Lead production teams and ensure quality standards in manufacturing operations.',
  },
  {
    id: 3,
    ...
    description: 'Conduct quality checks and maintain compliance with industry standards.',
  },
];
                ...
                <Row className="align-items-center">
                  <Col md={8}>
                    ...
                    <p className="mb-2">
                      ...
                      <i className="bi bi-briefcase ms-3 me-2"></i>{job.type} | 
                      <i className="bi bi-clock ms-3 me-2"></i>{job.experience}
                    </p>
                    <p className="mb-0 text-muted">{job.description}</p>
                  </Col>
                  <Col md={4} className="text-md-end mt-3 mt-md-0">
                    <a href="#apply-form" className="btn btn-outline-custom">
                      Apply Now
                    </a>
                  </Col>
                </Row>
        ...
        <Row className="justify-content-center" id="apply-form">
          <Col lg={8}>
            <div className="job-form-container">
              <h3 className="text-center text-gold mb-4">Submit Your Application</h3>
